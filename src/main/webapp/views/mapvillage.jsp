...
<div class= mapdata>
  ...
  <div class = battle_frame>
    ...
    <form class="battle_frame_btn_2" action="/village" method="post">
      <input type="hidden" name = 'action' value="2">
      <input type ='submit' value="신전가기" class = battle_frame_btn_1>
    </form>
    <form class="battle_frame_btn_3" action="/village" method="post">
