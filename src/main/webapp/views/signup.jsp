...
<section>
    <form class="signup_main" action="/signup" method="post">
        ...
        <div>
            ...
            <input class="idchk_btn" type="button" onclick="window.open('idCheck')" value="중복확인">
        </div>
        <div>
            <p class=" user_text">PASSWORD</p>
            <input  class="user_input" type="password" name="password" placeholder="비밀번호를 입력하세요" required>
        </div>
        <div>
            <p class=" user_text">USER NAME</p>
            <input  class="user_input" type="text" name = "name" placeholder="유저이름을 입력하세요" required>
        </div>
        <div>
