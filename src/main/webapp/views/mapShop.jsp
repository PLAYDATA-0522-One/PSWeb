...
<div class= mapdata>
  ...
  <img  class = map_spot src="img/shop.png" alt="shop">
  ...
  <div class = battle_frame>
    ...
    <form class="battle_frame_btn_2" action="/shop" method="post">
      <input type="hidden" name = 'action' value="2">
      <input type ='submit' value="판매하기" class = battle_frame_btn_1>
    </form>
    <form class="battle_frame_btn_3" action="/shop" method="post">
